    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-50 px-4">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              accept="image/*"
            />
            {errors.photoURL && <p className="text-sm text-red-500 mt-1">Photo URL is required</p>}
          </div>
          <div>
          ...
          <button type="submit" className="w-full bg-black text-white py-2 rounded hover:bg-gray-800 cursor-pointer">Register</button>
        </form>
        ...
        <p className="text-center mt-4 text-sm">
          Already have an account? <Link to="/auth/login" className="text-yellow-400">Login</Link>
        </p>
      </div>
    </div>
  );
